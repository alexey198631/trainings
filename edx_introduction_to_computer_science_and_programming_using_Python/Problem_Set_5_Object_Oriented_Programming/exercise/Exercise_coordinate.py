...
print(y.getX()) # output 18
print(p.getX()) # output 18
print(y == p) # output False

print(Coordinate(7, 9)) # output <7,9>
print(repr(p)) # Coordinate(18,20)
print(repr(y)) # Coordinate(18,19)
