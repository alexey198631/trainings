...
print(c.add_tent(Location(2, 3)))  # output: True
print(c.add_tent(Location(1, 2)))  # output: True
print(c.add_tent(Location(0, 0)))  # output: False
print(c.add_tent(Location(2, 3)))  # output: False
print(c.get_tents())  # output: ['<0,0>', '<1,2>', '<2,3>']
