...
class MITCampus(Campus):
    ...
    def add_tent(self, new_tent_loc):
        ...
        ch = True
        if new_tent_loc in self.all_tents:
            return False
        else:
...
print(c.add_tent(Location(1.45,1)))

"""
c = sm.MITCampus(sm.Location(1,2), sm.Location(3,1))
c.add_tent(sm.Location(1,1))
        print(c.add_tent(sm.Location(1.5,1)))
        
        c = sm.MITCampus(sm.Location(1,2), sm.Location(3,1))
        c.add_tent(sm.Location(1,1))
        print(c.add_tent(sm.Location(1.49,1)))
        c = sm.MITCampus(sm.Location(1,2), sm.Location(3,1))
        c.add_tent(sm.Location(1,1))
        print(c.add_tent(sm.Location(1.51,1)))"""
