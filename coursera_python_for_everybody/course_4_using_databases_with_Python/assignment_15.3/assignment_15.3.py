...
and then produce an SQLite database that contains a User, Course, and Member table and populate
...
conn = sqlite3.connect('data_files/rosterdb.sqlite')
cur = conn.cursor()
...
if len(fname) < 1:
    fname = 'data_files/roster_data.json'
