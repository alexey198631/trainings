...
If you run the program multiple times in testing or with dfferent files, make sure to empty out
...
Because the sample code is using an UPDATE statement and committing the results to the database as each record is read
in the loop, it might take as long as a few minutes to process all the data. The commit insists on completely
